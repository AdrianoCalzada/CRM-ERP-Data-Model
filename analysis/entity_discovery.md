...
- Company (<ins>company_id</ins>, name, address_street, address_number, address_postal_code, address_neighborhood, address_city, address_state, phone, website, created_at, updated_at, deleted_at)
...
- User (<ins>user_id</ins>, company_id, email, password_hash, first_name, last_name, phone, role, avatar_url, email_verified, is_active, last_login_at, created_at, updated_at, deleted_at)
...
- Contact (<ins>contact_id</ins>, company_id, type, first_name, last_name, email, phone, company_name, job_title, department, source, status, address_street, address_city, address_country, notes, tags, created_at, updated_at, deleted_at)
...
- Deal (<ins>deal_id</ins>, company_id, contact_id, owner_user_id, name, description, value, currency, stage, probability, expected_close_date, actual_close_date, status, loss_reason, created_at, updated_at, deleted_at)
...
- Product (<ins>product_id</ins>, company_id, type, name, description, sku, category, price, cost, currency, tax_rate, is_active, track_inventory, created_at, updated_at, deleted_at)
...
- Service (<ins>service_id</ins>, company_id, name, description, price, cost, currency, duration, category, is_active, created_at, updated_at, deleted_at)
...
- Invoice (<ins>invoice_id</ins>, company_id, contact_id, invoice_number, type, status, issue_date, due_date, paid_date, subtotal, tax_amount, total_amount, currency, notes, terms_and_conditions, idempotency_key, created_at, updated_at, deleted_at)
...
- Plan (<ins>plan_id</ins>, name, price_monthly, price_yearly, features, limits, is_active, created_at)
...
- Subscription (<ins>subscription_id</ins>, company_id, plan_id, plan_name, price, currency, billing_cycle, status, start_date, end_date, next_billing_date, stripe_subscription_id, idempotency_key, created_at)
...
- Revenue (<ins>revenue_id</ins>, company_id, contact_id, invoice_id, description, amount, revenue_date, category, cost_center_id, created_at, deleted_at)
...
- RevenueCategory (<ins>category_id</ins>, company_id, name, description, is_active, created_at)
...
- Expense (<ins>expense_id</ins>, company_id, description, category, amount, expense_date, vendor, payment_method, status, cost_center_id, created_at, updated_at, deleted_at)
...
- ExpenseCategory (<ins>category_id</ins>, company_id, name, description, is_active, created_at)
...
- CostCenter (<ins>cost_center_id</ins>, company_id, name, description, budget, actual_spend, color, is_active, created_at, updated_at, deleted_at)
...
- FinancialTransaction (<ins>transaction_id</ins>, company_id, transaction_type, related_entity_type, related_entity_id, amount, due_date, status, paid_date, bank_account_id, cost_center_id, created_at, updated_at)
...
- ClientApplication (<ins>application_id</ins>, company_id, contact_id, first_name, last_name, email, phone, cpf, cnpj, company_age, company_size, segment, revenue, has_physical_location, credit_purpose, notes, status, converted_at, created_at, updated_at, deleted_at)
...
- CreditAnalysis (<ins>analysis_id</ins>, company_id, client_application_id, analyst_user_id, risk_score, approved_amount, interest_rate, justification, status, created_at)
...
- Contract (<ins>contract_id</ins>, company_id, contact_id, total_value, interest_rate, installment_count, start_date, end_date, status, created_at, updated_at, deleted_at)
...
- ContractInstallment (<ins>installment_id</ins>, contract_id, installment_number, due_date, amount, status, paid_date, late_fee, created_at)
...
- BankAccount (<ins>bank_account_id</ins>, company_id, bank_name, agency, account_number, account_type, balance, is_active, created_at, updated_at, deleted_at)
...
- BankStatementEntry (<ins>entry_id</ins>, bank_account_id, transaction_date, description, amount, transaction_type, balance_after, reference_number, created_at)
...
- Payment (<ins>payment_id</ins>, company_id, contract_installment_id, bank_account_id, amount, payment_date, payment_method, reference_number, status, idempotency_key, created_at)
...
- Document (<ins>document_id</ins>, company_id, entity_type, entity_id, document_type, file_name, file_path, file_size, mime_type, storage_provider, bucket, checksum, version, uploaded_by, uploaded_at, expires_at, deleted_at)
...
- CalendarEvent (<ins>event_id</ins>, company_id, title, description, start_time, end_time, entity_type, entity_id, created_by, reminder_sent, status, created_at)
...
- Task (<ins>task_id</ins>, company_id, assigned_to, title, description, due_date, priority, status, entity_type, entity_id, completed_at, created_at, deleted_at)
...
- Activity (<ins>activity_id</ins>, company_id, user_id, contact_id, deal_id, type, subject, description, content, due_date, completed_date, status, created_at, updated_at, deleted_at)
...
- Sale (<ins>sale_id</ins>, company_id, contact_id, total_amount, sale_date, status, payment_terms, created_at, deleted_at)
...
- SaleItem (<ins>sale_item_id</ins>, sale_id, product_id, service_id, quantity, unit_price, total_amount, created_at)
...
- InventoryMovement (<ins>movement_id</ins>, company_id, product_id, movement_type, quantity, unit_cost, reference_id, notes, created_at)
...
- AuditLog (<ins>log_id</ins>, company_id, user_id, action, entity_type, entity_id, old_values, new_values, ip_address, user_agent, timestamp)
...
- UserRole (<ins>role_id</ins>, company_id, name, permissions, is_system_role, created_at)
...
- Integration (<ins>integration_id</ins>, company_id, service_name, api_key, config_data, is_active, last_sync_at, created_at)
...
- Notification (<ins>notification_id</ins>, company_id, user_id, title, message, type, is_read, action_url, created_at)

## Authentication & Security

### Session
- Session (<ins>session_id</ins>, user_id, expires_at, created_at)

### PasswordResetToken
- PasswordResetToken (<ins>token_id</ins>, user_id, token, expires_at, used_at, created_at)

### EmailVerificationToken
- EmailVerificationToken (<ins>token_id</ins>, user_id, token, expires_at, used_at, created_at)

### OAuthAccount
- OAuthAccount (<ins>oauth_account_id</ins>, user_id, provider, provider_user_id, access_token, refresh_token, expires_at, created_at, updated_at)

### TwoFactor
- TwoFactor (<ins>two_factor_id</ins>, user_id, totp_secret, backup_codes, enabled_at, created_at)

## Webhooks & Jobs

### WebhookEndpoint
- WebhookEndpoint (<ins>endpoint_id</ins>, company_id, url, event_types, secret, is_active, created_at)

### WebhookDelivery
- WebhookDelivery (<ins>delivery_id</ins>, endpoint_id, event_name, payload, attempt, status, error, next_retry_at, idempotency_key, created_at)

### JobQueue
- JobQueue (<ins>job_id</ins>, type, payload, run_at, attempts, status, last_error, created_at, updated_at)
...
- CompanySettings (<ins>company_id</ins>, razao_social, cnpj, endereco, telefone, logo_ref, theme_settings, security_settings, integration_settings, updated_at)
...
- TenantSetting (<ins>setting_id</ins>, company_id, setting_key, setting_value, data_type, updated_at)
...
- EmailTemplate (<ins>template_id</ins>, company_id, name, subject, body, variables, is_active, created_at)
...
- ReportSchedule (<ins>schedule_id</ins>, company_id, report_type, frequency, parameters, last_run_at, next_run_at, is_active, created_at)
...
- KPI (<ins>kpi_id</ins>, company_id, name, calculation_query, target_value, current_value, period, updated_at)
...
- CompanyDomain (<ins>domain_id</ins>, company_id, domain_name, is_primary, verified_at, created_at)
