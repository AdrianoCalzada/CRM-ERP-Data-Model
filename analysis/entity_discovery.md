# Entity Discovery - CRM/ERP System
...
- **Company** (<u>company_id</u>, name, address_street, address_number, address_postal_code, address_neighborhood, address_city, address_state, phone, website, created_at, updated_at)
...
- **User** (<u>user_id</u>, company_id, email, password_hash, first_name, last_name, phone, role, avatar_url, email_verified, is_active, last_login_at, created_at, updated_at)
...
- **Contact** (<u>contact_id</u>, company_id, type, first_name, last_name, email, phone, company_name, job_title, department, source, status, address_street, address_city, address_country, notes, tags, created_at, updated_at)
...
- **Deal** (<u>deal_id</u>, company_id, contact_id, owner_user_id, name, description, value, currency, stage, probability, expected_close_date, actual_close_date, status, loss_reason, created_at, updated_at)
...
- **Product** (<u>product_id</u>, company_id, type, name, description, sku, category, price, cost, currency, tax_rate, is_active, track_inventory, created_at, updated_at)
...
- **Service** (<u>service_id</u>, company_id, name, description, price, cost, currency, duration, category, is_active, created_at, updated_at)

### Invoice
**Purpose**: Billing documents and financial records
**Business Role**: Revenue recognition and accounts receivable
**Key Attributes**: id, company_id, client_id, amount, status, dates, tax_info
- **Invoice** (<u>invoice_id</u>, company_id, contact_id, invoice_number, type, status, issue_date, due_date, paid_date, subtotal, tax_amount, total_amount, currency, notes, terms_and_conditions, created_at, updated_at)
...
**Key Attributes**: company_id, plan_type, billing_cycle, status, dates, payment_info
- **Subscription** (<u>subscription_id</u>, company_id, plan_type, price, billing_cycle, status, start_date, end_date, next_billing_date, stripe_subscription_id, created_at)
...
**Key Attributes**: id, company_id, client_id, amount, date, category, source
- **Revenue** (<u>revenue_id</u>, company_id, client_id, invoice_id, description, amount, revenue_date, category, cost_center_id, created_at)
...
- **Expense** (<u>expense_id</u>, company_id, description, category, amount, expense_date, vendor, payment_method, status, cost_center_id, created_at, updated_at)
...
- **CostCenter** (<u>cost_center_id</u>, company_id, name, description, budget, actual_spend, color, is_active, created_at, updated_at)
...
- **ClientApplication** (<u>application_id</u>, company_id, client_id, first_name, last_name, email, phone, cpf, cnpj, company_age, company_size, segment, revenue, has_physical_location, credit_purpose, notes, status, created_at, updated_at)
...
**Key Attributes**: id, company_id, client_id, terms, value, dates, status
- **Contract** (<u>contract_id</u>, company_id, client_id, total_value, interest_rate, installment_count, start_date, end_date, status, created_at, updated_at)
...
- **BankAccount** (<u>bank_account_id</u>, company_id, bank_name, agency, account_number, account_type, balance, is_active, created_at, updated_at)
...
- **Payment** (<u>payment_id</u>, company_id, contract_installment_id, bank_account_id, amount, payment_date, payment_method, reference_number, status, created_at)
...
- **Document** (<u>document_id</u>, company_id, entity_type, entity_id, document_type, file_name, file_path, file_size, mime_type, uploaded_by, uploaded_at, expires_at)
...
- **Task** (<u>task_id</u>, company_id, assigned_to, title, description, due_date, priority, status, entity_type, entity_id, completed_at, created_at)
...
- **Activity** (<u>activity_id</u>, company_id, user_id, contact_id, deal_id, type, subject, description, content, due_date, completed_date, status, created_at, updated_at)
...
**Key Attributes**: id, company_id, client_id, items, total, dates, status
- **Sale** (<u>sale_id</u>, company_id, client_id, total_amount, sale_date, status, payment_terms, created_at)
